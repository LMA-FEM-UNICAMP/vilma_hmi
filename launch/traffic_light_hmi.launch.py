...
def launch_setup(context, *args, **kwargs):
    ...
    server_dir = os.path.join(get_package_share_directory("vilma_hmi"), "website", "adas")
    params_dir = os.path.join(get_package_share_directory("vilma_hmi"), "config")
    
    params = load_yaml(os.path.join(params_dir, interface + ".param.yaml"))
    ...
    symlink_force(os.path.join(server_dir, 'traffic_light.html'), os.path.join(server_dir, 'index.html'))
